        ...
        contents: [
          {
            ...
            parts: [
              {
                text: `Extraia integral e literalmente todos os dados do seguinte orçamento para o JSON especificado, sem resumir, sem cortar texto, mantendo 100% do escopo técnico e sem inventar nada:\n\n${text}`,
              },
            ],
          },
        ],
