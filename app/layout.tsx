  ...
  return (
    <html lang="pt-br">
      <head>
        ...
        <link rel="apple-touch-icon" href="/pix/ea/EA-logo-512.png" />
        <link rel="icon" type="image/png" href="/pix/ea/ea-Name.png" />
        <link
          rel="icon"
          type="image/png"
          sizes="32x32"
      ...
      >
        ...
        <ThemeProvider defaultTheme="light">
          <LanguageProvider defaultLanguage="pt">{children}</LanguageProvider>
        </ThemeProvider>
