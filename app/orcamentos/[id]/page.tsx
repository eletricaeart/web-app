...
interface BudgetData {
  ...
  financial?: {
    // ALTERAÇÃO: Adicionado objeto financial na interface principal
    labor: number;
    materials: number;
    discount: number;
    total: number;
...
export default function Budget() {
  ...
  const displayData = data
    ? {
        ...
        // ALTERAÇÃO: Mapeamento do objeto financeiro global
      ...
      <View tag="pageContainer">
        <View tag="budget-page" ref={budgetRef}>
          ...
          <View tag="budget-body">
            ...
            {/* COMPONENTE: Inclusão do Resumo Financeiro no corpo do documento */}
            {/* <FinancialTable summary={displayData.financial} /> */}
...
// Novo componente para a tabela de fechamento financeiro
{
  /* function FinancialTable({ summary }: { summary: any }) {
  ...
  return (
    ...
    >
      ...
      {summary.labor > 0 && (
        <div style={rowStyle}>
          <span style={labelStyle}>MÃO DE OBRA ADICIONAL:</span>
          <span style={valueStyle}>
            {new Intl.NumberFormat("pt-BR", {
              style: "currency",
              currency: "BRL",
            }).format(summary.labor)}
          </span>
        </div>
      )}
      ...
      {summary.discount > 0 && (
        <div style={rowStyle}>
          ...
          <span style={{ ...valueStyle, color: "#d32f2f" }}>
            -
            {new Intl.NumberFormat("pt-BR", {
              style: "currency",
              currency: "BRL",
      ...
      >
        <span style={{ ...labelStyle, color: "#000", fontSize: "1rem" }}>
          TOTAL FINAL:
        </span>
        <span style={{ ...valueStyle, fontSize: "1.2rem", color: "#00559c" }}>
          {new Intl.NumberFormat("pt-BR", {
            style: "currency",
            currency: "BRL",
