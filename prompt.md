me ajuda a corrigir um funcionamento de um processo do app:

se eu entro em criar um novo orçamento e no cliente eu escolho criar um novo cliente eu sou levado para a pagina de criação do cliente, mas ao salvar o cliente eu sou levado para a pagina de clientes, quero mudar isso e voltar para a pagina anterior que era a de criação do orçamento e trazer os dados do cliente que foi criado e os dados que eu ja tinha editado do novo orçamento se eles existirem,

vou te enviar os arquivos relacionados para você analisar isso. e tem também um alteração para esse trecho de codigo da pagina de criação de novo cliente ({/_ Campo de Observações _/}
          ...
          </View>) quero que esse campo só apareça se estiver dentro da pagina de criação do cliente e não apareça se estiver dentro da pagina de criação do orçamento.

os arquivos estão em anexo e outros aqui em baixo.
