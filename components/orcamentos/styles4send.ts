// components/orcamentos/styles4send.ts
...
cliente-section > ui > header > ui {
  ...
  align-items: center;
  justify-content: center;
  /* border-top: #0505 2px dotted; */
  /* border-bottom: #0505 2px dotted; */
  border-radius: 12px;
  flex-direction: column;
  text-align: center;
  align-items: center;
...
cliente-section > ui > header > ui > t {
  font-family: "inter", "Roboto", sans-serif;
  overflow-wrap: break-word;
  display: block;
  font-size: 1em;
...
cliente-section > ui > content > card {
  display: flex;
  flex-direction: column;
  width: 100%;
  margin: 0;
...
cliente-section > ui > content > card > ui {
  padding: 1em;
  background: #fff;
}

cliente-section > ui > content > card > ui t {
  font-family: "inter", "Roboto", sans-serif;
  font-weight: normal;
  overflow-wrap: break-word;
  display: block;
...
footer-content_bottom > ui > header {
  display: block;
  unicode-bidi: isolate;
  color: var(--sv-azul-bebe);
  width: 100%;
...
footer-content_bottom > ui > header > ui {
  display: flex;
  width: 100%;
  height: 46px;
  height: 26px;
...
footer-content_bottom > ui > header > ui > t {
  font-family: "inter", "Roboto", sans-serif;
  overflow-wrap: break-word;
  display: block;
  font-size: 1em;
...
/* --- regras para truncar nomes e titulos nos cards */
.info-content h3,
.info-content p {
...
/* Garante que o container flexível não "empurre" os ícones para fora */
.orcamento-card {
  display: flex;
  align-items: center;
  gap: 12px;
...
.info-content {
  flex: 1; /* Faz com que o texto ocupe todo o espaço central */
  min-width: 0; /* TRUQUE CRÍTICO: permite que o flex-item encolha abaixo do conteúdo */
  cursor: pointer;
}
...
@media print {
  ...
  * {
  ...
  @page {
    ...
    /* margin: 1cm; /* Sua margem atual */
    /* Não é possível colocar 'background' direto aqui, então usamos o truque abaixo */
    /* margin-left: 10x; */
    /* margin-right: 10x; */
  }
  ...
  body {
    ...
    display: block !important; /* Remove flexbox que pode bugar quebras */
  ...
  /* Força o container do orçamento a ocupar todo o espaço necessário */
  homepage,
  home-page,
  invoice_html {
    height: auto !important;
    ...
    position: static !important; /* Remove fixação ou sticky */
    /* padding: 0 !important; */
    /* margin: 0 !important; */
  }
  ...
  /* Ajuste para que cabeçalhos não fiquem sozinhos no fim da página */
  clause-header,
  subclause-header {
...
/* Efeito visual de "bloco" ao passar o mouse ou focar */
.tiptap-content p:hover {
...
.slash-item.is-selected {
  background: #f3f4f6;
  color: #ffab00; /* Cor padrão Elétrica & Art */
}

/* TipTapEditor.css */
.tiptap-container blockquote {
  border-left: 4px solid #ffab00; /* Laranja da Elétrica & Art */
  border-left: #29f 4px solid;
