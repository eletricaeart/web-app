// components/painel/ferramentas/drywall/DrywallToolsPage.tsx
'use client';
  ...
  const tools = [
    {
      ...
      route: 'ferramentas.drywall.paredes',
    ...
    },
    {
      ...
      route: 'ferramentas.drywall.moveis',
    ...
    <>
      ...
      >
        ...
        <p className="text-slate-500 text-sm mb-6">
          Selecione a calculadora específica para seu projeto em drywall.
        </p>
